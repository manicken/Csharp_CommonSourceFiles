...
namespace System.Windows.Forms
{
    public static class QuickDialogs
    {
        ...
        public static bool MessageBoxVerifyAction(string title, string text)
        {
            return (DialogResult.Yes == MessageBox.Show(text, title, MessageBoxButtons.YesNo, MessageBoxIcon.Question));
        }
    }
}
namespace CGS
