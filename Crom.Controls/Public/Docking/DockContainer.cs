...
namespace Crom.Controls.Docking
{
   ...
   public class DockContainer : UserControl
   {
      ...
      public FormsDocker           _docker              = null;
      ...
      public void Undock(DockableFormInfo info)
      {
            _docker.Undock(info, new Rectangle(0, 0, info.DockableForm.Width, info.DockableForm.Height));
      }
      
      public FormsDecorator GetFormsDecorator(DockableFormInfo info)
      {
            return HierarchyUtility.GetFormsDecorator(info.DockableForm);
      }
      
      public FormsContainer GetFormsContainer(DockableFormInfo info)
      {
            return HierarchyUtility.GetFormsContainer(info.DockableForm);
      }
