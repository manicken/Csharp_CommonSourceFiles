...
namespace ControlManager
{
    internal class ControlMoverOrResizer
    {
        ...
        public static Action<Control> ControlMovedOrResized;
        ...
        private static void UpdateMouseEdgeProperties(Control control, Point mouseLocationInControl)
        {
            ...
            {
                MouseIsInRightEdge = Math.Abs(mouseLocationInControl.X - (control.Width - 6)) <= 2;
                MouseIsInBottomEdge = Math.Abs(mouseLocationInControl.Y - (control.Height - 6)) <= 2;
            }
        ...
        private static void StopDragOrResizing(Control control)
        {
            ...
            if (ControlMovedOrResized != null)
                ControlMovedOrResized(control);
        }
