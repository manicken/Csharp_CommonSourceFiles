...
namespace Crom.Controls.Docking
{
   ...
   /// </summary>
   public class FormsDecorator : Control
   {
      #region Fields
      ...
      public ControlPositioner     _positioner                         = null;
      private bool                  _isFocused                          = false;

      private Point                 _mouseDownScreenPos                 = new Point();
      private Point                 _positionerPositionOnMouseDown      = new Point();
      public Size                  _positionerSizeOnMouseDown          = new Size();
      public zSizeMode             _sizeMode                           = zSizeMode.None;
      ...
      private void OnPaintTitleBar(object sender, PaintEventArgs e)
      {
         ...
         _titleRenderer.Draw(font, e.Graphics);
      }
      ...
      /// </summary>
      public void ApplyTopFormMargins()
      {
         FormsContainerControlCollection forms = (FormsContainerControlCollection)FormsPanel.Controls;
      ...
      /// </summary>
      public void SetFormsPanelBounds()
      {
         if (CanResizeByMouse)
         {
            FormsPanel.Bounds = ClientRectangle;
